...
# needs pip install streamlit_drawable_canvas and pip install streamlit potentially
# set "export STREAMLIT_SERVER_MAX_UPLOAD_SIZE=100" for max upload file size = 100 as environment variable
